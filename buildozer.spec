...
# (str) Package name
package.name = beachturnier

# (str) Package domain (needed for android/ios packaging)
package.domain = org.beachturnier
...
requirements = python3,kivy,pandas,openpyxl,jdcal,et_xmlfile,certifi,idna,urllib3,chardet
